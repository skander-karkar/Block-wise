...
def imagenet2012_dataloaders(batchsize, trainsize = 0.98, valsize = 0.01, testsize = 0.01, noise = 0):
...
def tinyimagenet_dataloaders(batchsize, trainsize = 1, valsize = 0.5, testsize = 0.5, noise = 0):
